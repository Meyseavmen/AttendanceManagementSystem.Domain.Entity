        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAccounctOfEmployeeId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAccounts", x => x.UserAccountID);
                    table.ForeignKey(
                        name: "FK_UserAccounts_Employees_UserAccounctOfEmployeeId",
                        column: x => x.UserAccounctOfEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAccounts_UserAccounctOfEmployeeId",
                table: "UserAccounts",
                column: "UserAccounctOfEmployeeId",
                unique: true);
        }
